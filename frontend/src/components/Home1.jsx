...
{/* 
      ...
      <div className="categories grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-2 gap-1 px-1 py-1">
  {categories.map((i, index) => (
    <div
      key={index}
    ...
    >
      ...
      <h3
        className="absolute bottom-2 lg:bottom-4 left-0 right-0 text-center 
                   text-sm lg:text-xl text-white font-semibold drop-shadow-lg"
        style={{ fontFamily: "math" }}
      >
        {i.title}
      </h3>
...
{/* 
  ...
  {/* Heading */}
  <div className="text-left py-8 px-4">
    <h2 className="mt-3 text-xl sm:text-2xl md:text-3xl font-serif font-semibold text-gray-800">
      Shop Men
    </h2>
    ...
    <div className="flex justify-between items-center">
      ...
      <p className="text-gray-500 md:font-medium text-sm border-b-2 border-gray-300 pb-1">
        Shop Men
      </p>
    </div>
  </div>
  ...
  {/* <div className="relative px-4 mb-6">
    <button className="men-prev absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full w-10 h-10 flex items-center justify-center shadow">
      <FaChevronLeft />
    </button>

    <button className="men-next absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full w-10 h-10 flex items-center justify-center shadow">
      <FaChevronRight />
    </button>
...
>
  ...
  <div className="relative px-4 mb-6">
      <button className="men-prev absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full w-10 h-10 flex items-center justify-center shadow disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none">
        <FaChevronLeft />
      </button>

      <button className="men-next absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full w-10 h-10 flex items-center justify-center shadow disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none">
        <FaChevronRight />
      </button>
  ...
  <hr className="mx-3 mt-10 border-gray-300" />
</div>
