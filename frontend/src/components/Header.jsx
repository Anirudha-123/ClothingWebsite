...
useEffect(() => {
  ...
  return (
    <>
      <div className="header fixed  top-0 left-0 right-0 z-50 bg-gray-900 max-w-8xl   mx-auto  flex justify-between items-center px-3 h-14 md:h-16 border-b-2 border-white/20">
        <Link to="/">
