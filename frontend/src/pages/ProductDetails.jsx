...
const ProductDetails = () => {
  ...
  if (loading) {
    return (
      <h3 className="absolute inset-0 flex items-center justify-center font-bold text-2xl text-gray-800 ">
        Loading...
      </h3>
    );
  }
      ...
      <div className="flex lg:flex-col gap-1 order-2 lg:order-1 h-full" >
        {images.map((i, index) => (
          <img
            ...
            src={i}
            alt="thumb"
            className="w-36 h-39 sm:w-28 sm:h-32 lg:w-56  lg:h-51
                       object-cover cursor-pointer md:border
                       md:hover:border-black transition"
